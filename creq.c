/* File creq.c */
  ...
  /**********************************************************************
  * Written by Allen Martin (amartin@cs.wpi.edu) and included with the  *
  * package libsx as an example of libsx usage.  GetColor() is modified *
  * to return TRUE=1 when the user selects a color and FALSE=0 when     *
